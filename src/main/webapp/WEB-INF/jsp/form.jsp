...
<body>
	...
	<form action="/post/write" onsubmit="$('#content').val($('#pen').html()); pen.destroy();" method="post">
		<input type="text" name="subject" placeholder="Subject"
			style="height: 70px; width: 100%; font-size: 55px; border: none; border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 1px;
			outline-style: none; font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 800;">
